...
class BotAmino(Command, Client, TimeOut, BannedWords):
    def __init__(self, email: str = None, password: str = None, sid: str = None,  proxies: dict = None, deviceId: str = "172d156c4fbabc3ec1083724fedd9cc6bf85fd8a66cbf049ddbfacaea114dc318eee8044e025e2910f", certificatePath: str = None):
        Command.__init__(self)
        Client.__init__(self, proxies=proxies, deviceId="172d156c4fbabc3ec1083724fedd9cc6bf85fd8a66cbf049ddbfacaea114dc318eee8044e025e2910f", certificatePath=certificatePath)
